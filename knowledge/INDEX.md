...
- [adrt-geometry](adrt-geometry.md) — quadrant/offset/angle conventions, per-quadrant angle ranges, `coord_adrt`, normalized-offset gotcha; read before ADRT peak detection.
